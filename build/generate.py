...
bin_path = '../MSF.Powershell/bin/Release/MSF.Powershell.dll'
#bin_path = '../MSF.Powershell/bin/Debug/MSF.Powershell.dll'
target_path = '../../metasploit-payloads/c/meterpreter/source/extensions/powershell'
...
write_all('{0}/powershell_runner.h'.format(target_path), header)
write_all('{0}/powershell_runner.cpp'.format(target_path), source)
